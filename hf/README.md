...
## Inference 
```bash
$ python inference.py --data_path '/content/drive/MyDrive/깃헙/Projects/AICONNECT/data/' \
                     --model_save '/content/drive/MyDrive/깃헙/Projects/AICONNECT/test/model/hf_t5_lora/' \
                     --sub_path '/content/drive/MyDrive/깃헙/Projects/AICONNECT/test/sub/' \
